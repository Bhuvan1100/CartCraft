...
export default function SimilarProducts({ products = [] }) {
    ...
    const displayProducts = products.length > 0 ? products.slice(0, 8) : defaultProducts;
    const totalPages = 2; // Always 2 pages (4 items each)
    ...
    const visibleProducts = displayProducts.slice(startIndex, startIndex + 4);
